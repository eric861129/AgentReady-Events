...
- Deployment status: E3 verified; targeted recovery v2 is 3/5 executed, with `STALE-01-V2`, `CONF-02-V2` and `STALE-02-V2` passing once each
...
- 新題庫為 `evals/dataset/targeted-recovery-v2.json`，目前 3/5 executed；不改寫原始 20 題題庫或 revision `0000008` 的 8 PASS／5 FAIL。
