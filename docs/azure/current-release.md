...
- Deployment status: E3 verified; targeted Inspector cases have not been rerun yet
...
- 新題庫為 `evals/dataset/targeted-recovery-v2.json`，不改寫原始 20 題題庫或 revision `0000008` 的 8 PASS／5 FAIL。
